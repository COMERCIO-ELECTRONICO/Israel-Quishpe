...
@Injectable() // servicio
export class IngresarProductoService {
  ...
  ingresarProductos(productosIngresados){
      const url = 'http://localhost:1337/articulo'
      return this._httpClient.post(url, productosIngresados);
  }
